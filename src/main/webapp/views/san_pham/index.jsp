...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="box container my-2">
            <h2>Danh sach sản phẩm</h2>
            <div class="d-flex justify-content-between">
                <form action="/san-pham/index" method="get" class="d-flex align-items-center">
                    <div class="row mx-2">
                        <div class="col-md-15">
                ...
                <div class="my-3">
                    <a class="btn btn-primary" href="/san-pham/create">Tạo mới</a>
            ...
            <table class="table">
                ...
                <c:forEach items="${listSP.content}" var="sp">
                    <tr>
                        ...
                        <td>${sp.hienThiTT()}</td>
                        <td>
                            <a class="btn btn-warning" href="/san-pham/edit/${sp.id}">Update</a>
            ...
            <nav>
                <ul class="pagination d-flex justify-content-center">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/san-pham/index?page=${currentPage - 1}&limit=${pageSize}">Previous</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                    <!-- Page Numbers -->
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="/san-pham/index?page=${i}&limit=${pageSize}">${i}</a>
                        </li>
                    </c:forEach>
                    <!-- Next Button -->
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/san-pham/index?page=${currentPage + 1}&limit=${pageSize}">Next</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </ul>
