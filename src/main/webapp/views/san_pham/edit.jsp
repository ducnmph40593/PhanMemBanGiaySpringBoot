...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="box container my-2">
            <h2>Sửa sản phẩm </h2>
            <form action="/san-pham/update/${sanPhamDetail.id}" method="post">
                <div class="my-3">
                ...
                <div class="my-3">
                    ...
                    <select id="" class="form-select" name="trangThai">
                        <option value="0"${sanPhamDetail.trangThai ==0 ? "selected":""}>Hoạt động</option>
                        <option value="1"${sanPhamDetail.trangThai ==1 ? "selected":""}>Ngừng hoạt động</option>
                    </select>
                </div>
                <div class="my-3">
