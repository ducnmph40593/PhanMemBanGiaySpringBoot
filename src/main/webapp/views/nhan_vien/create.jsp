        ...
        <div class="box container my-2">
            ...
            <form action="/nhan-vien/store" method="post">
                ...
                <div class="my-3">
                    ...
                    <input class="form-control" type="text" name="tenDN" value="${data.tenDN}">
                    <c:if test="${not empty errors['tenDN']}">
                        <div class="alert alert-danger mt-2">${errors['tenDN']}</div>
                    </c:if>
                </div>
                <div class="my-3">
                    <label class="form-label">Mật khẩu</label>
                    <input class="form-control" type="password" name="matKhau" value="${data.matKhau}">
                    <c:if test="${not empty errors['matKhau']}">
                        <div class="alert alert-danger mt-2">${errors['matKhau']}</div>
                    </c:if>
                </div>
                <div class="my-3">
