...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="box container my-2">
            ...
            <form action="/kich-thuoc/update/${listKTDetail.id}" method="post">
                <div class="my-3">
                    <label class="form-lable">Mã kích thước</label>
                    <input class="form-control" type="text" name="ma" value="${listKTDetail.ma}">
                ...
                <div class="my-3">
                    ...
                    <input class="form-control" type="text" name="ten" value="${listKTDetail.ten}">
                ...
                <div class="my-3">
                    ...
                    <select id="" class="form-select" name="trangThai">
                        <option value="0"${listKTDetail.trangThai ==0 ? "selected":""}>Hoat động</option>
                        <option value="1"${listKTDetail.trangThai ==1 ? "selected":""}>Ngừng hoạt động</option>
                    </select>
                </div>
                <div class="my-3">
                    <button class="btn btn-warning">Sửa</button>
                    <a class="btn btn-light" href="/kich-thuoc/index">Quay lại</a>
                </div>
            </form>
        </div>
        <%--Footer--%>
