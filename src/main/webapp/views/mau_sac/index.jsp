    ...
    <div class="main">
        ...
        <div class="box container my-2">
            ...
            <div class="d-flex justify-content-between">
                <form action="/mau-sac/index" method="get" class="d-flex align-items-center">
                    <div class="row mx-2">
                        <div class="col-md-15">
                ...
                <div class="my-3">
                    <a class="btn btn-primary" href="/mau-sac/create">Tạo mới</a>
            ...
            <table class="table">
                ...
                <c:forEach items="${listMS.content}" var="ms">
                    <tr>
                        ...
                        <td>${ms.hienThiTT()}</td>
                        <td>
                            <a class="btn btn-warning" href="/mau-sac/edit/${ms.id}">Update</a>
            ...
            <nav>
                <ul class="pagination d-flex justify-content-center">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/mau-sac/index?page=${currentPage - 1}&size=${pageSize}">Previous</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                    <!-- Page Numbers -->
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="/mau-sac/index?page=${i}&size=${pageSize}">${i}</a>
                        </li>
                    </c:forEach>
                    <!-- Next Button -->
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/mau-sac/index?page=${currentPage + 1}&size=${pageSize}">Next</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </ul>
