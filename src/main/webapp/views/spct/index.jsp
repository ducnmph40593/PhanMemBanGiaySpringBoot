    ...
    <div class="main">
        ...
        <div class="box container my-2">
            ...
            <div class="d-flex justify-content-between">
                <form action="/spct/index" method="get" class="d-flex align-items-center">
                    <label class="form-label">Sản phẩm :</label>
                    <div class="row mx-2">
                        <div class="col-md-15">
                            <select name="idSanPham" id="idSanPham" class="form-select me-2">
                ...
                <div class="my-3">
                    <a class="btn btn-primary mb-3" href="/spct/create">Tạo mới</a>
            ...
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${listSPCT.content}" var="sp">
                    <tr>
                        <td>${sp.id}</td>
                        <td>${sp.ma}</td>
                        ...
                        <td>${sp.hienThiTT()}</td>
                        <td>
                            <a class="btn btn-warning" href="/spct/edit/${sp.id}">Update</a>
                            <a class="btn btn-danger" href="/spct/delete/${sp.id}">Xóa</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <nav>
                <ul class="pagination d-flex justify-content-center">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/spct/index?page=${currentPage - 1}&size=${pageSize}">Previous</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                    <!-- Page Numbers -->
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="/spct/index?page=${i}&size=${pageSize}">${i}</a>
                        </li>
                    </c:forEach>
                    <!-- Next Button -->
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link"
                                   href="/spct/index?page=${currentPage + 1}&size=${pageSize}">Next</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </ul>
