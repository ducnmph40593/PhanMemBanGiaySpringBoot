...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="box container my-2">
            ...
            <form action="/spct/update/${listSPCTDetail.id}" method="post">
                <div class="my-3">
                    <label class="form-lable">Mã SPCT</label>
                    <input class="form-control" type="text" name="ma" value="${listSPCTDetail.ma}">
                ...
                <div class="my-3">
                    ...
                    <select name="idSanPham" class="form-select me-2">
                        <c:forEach var="i" items="${listSP}">
                            <option value="${i.id}"
                                    <c:if test="${i.id == listSPCTDetail.idSanPham.id}">selected</c:if>
                            >${i.ten}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="my-3">
                    ...
                    <select name="idMauSac" class="form-select me-2">
                        <c:forEach var="i" items="${listMS}">
                            <option value="${i.id}"
                                    <c:if test="${i.id == listSPCTDetail.idMauSac.id}">selected</c:if>
                            >${i.ten}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="my-3">
                    ...
                    <select name="idKichThuoc" class="form-select me-2">
                        <c:forEach var="i" items="${listKT}">
                            <option value="${i.id}"
                                    <c:if test="${i.id == listSPCTDetail.idKichThuoc.id}">selected</c:if>
                            >${i.ten}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="my-3">
                    ...
                    <input class="form-control" type="text" name="soLuong" value="${listSPCTDetail.soLuong}">
                ...
                <div class="my-3">
                    ...
                    <input class="form-control" type="text" name="donGia" value="${listSPCTDetail.donGia}">
                ...
                <div class="my-3">
                    ...
                    <select id="" class="form-select" name="trangThai">
                        <option value="0"${listSPCTDetail.trangThai ==0 ? "selected":""}>Hoạt động</option>
                        <option value="1"${listSPCTDetail.trangThai ==1 ? "selected":""}>Ngừng hoạt động</option>
                    </select>
                </div>
                <div class="my-3">
                    <button class="btn btn-primary">Sửa</button>
                    <a class="btn btn-light" href="/spct/index">Quay lại</a>
                </div>
            </form>
        </div>
        <%--Footer--%>
