    ...
    <div class="main">
        ...
        <div class="box container my-2">
            ...
            <div class="d-flex justify-content-between">
                <form action="/hoa-don/index" method="get" class="d-flex align-items-center">
                    <div class="row mx-2">
                        <div class="col-md-15">
                            <select name="idKH" id="idKH" class="form-select me-2">
            ...
            <table class="table">
                ...
                <c:forEach items="${listHD.content}" var="hd">
                    <tr>
                        ...
                        <td>${hd.hienThiTT()}</td>
                        <td>
                            <a class="btn btn-warning" href="/hoa-don/edit/${hd.id}">Update</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <nav>
                <ul class="pagination d-flex justify-content-center">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/hoa-don/index?page=${currentPage - 1}&size=${pageSize}">Previous</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                    <!-- Page Numbers -->
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="/hoa-don/index?page=${i}&size=${pageSize}">${i}</a>
                        </li>
                    </c:forEach>
                    <!-- Next Button -->
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link"
                                   href="/hoa-don/index?page=${currentPage + 1}&size=${pageSize}">Next</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </ul>
