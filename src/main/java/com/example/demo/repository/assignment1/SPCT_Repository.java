...
//        this.listSPCT.add(new SPCT(1, "SPCT1", 1, 1, 1, 33, 18.0, 0));
//        this.listSPCT.add(new SPCT(2, "SPCT2", 2, 2, 2, 25, 16.0, 1));
//        this.listSPCT.add(new SPCT(3, "SPCT3", 3, 3, 3, 15, 26.0, 1));
//        this.listSPCT.add(new SPCT(4, "SPCT4", 3, 3, 3, 15, 26.0, 1));
//        this.listSPCT.add(new SPCT(5, "SPCT5", 2, 2, 2, 15, 26.0, 1));
//    }
//
